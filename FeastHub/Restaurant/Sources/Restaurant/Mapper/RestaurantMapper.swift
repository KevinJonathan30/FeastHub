...
public class RestaurantMapper {
    ...
    public static func mapRestaurantResponseToModel(
    ...
    public static func mapRestaurantResponseListToModelList(
    ...
    public static func mapRestaurantEntityListToModelList(
    ...
    public static func mapRestaurantModelToEntity(
