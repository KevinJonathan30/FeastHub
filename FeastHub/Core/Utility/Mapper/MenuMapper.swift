...
final class MenuMapper {
    ...
    static func mapMenuResponseToModel(
    ...
    static func mapFoodResponseListToModelList(
    ...
    static func mapDrinkResponseListToModelList(
    ...
    static func mapMenuEntityToModel(
    ...
    static func mapFoodEntityListToModelList(
    ...
    static func mapDrinkEntityListToModelList(
    ...
    static func mapMenuModelToEntity(
    ...
    static func mapFoodModelListToEntityList(
    ...
    static func mapDrinkModelListToEntityList(
